...
let s:p.inactive.right = [ [ '#abb2bf', '#2F2F4A', s:term_black, s:term_blue], [ '#abb2bf', '#211d33', s:term_white, s:term_grey ] ]
let s:p.inactive.left = [ [ '#abb2bf', '#2F2F4A', s:term_black, s:term_blue], [ '#abb2bf', '#211d33', s:term_white, s:term_grey ] ]
...
let s:p.inactive.middle = [ [ '#abb2bf', '#110f19', s:term_white, s:term_black ] ]
