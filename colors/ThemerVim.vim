  ...
  let s:guishade0 = "#1f132a"
  let s:guishade1 = "#3a3044"
  let s:guishade2 = "#564d5d"
  let s:guishade3 = "#716a77"
  let s:guishade4 = "#8c8791"
  let s:guishade5 = "#a7a4ab"
  let s:guishade6 = "#c3c1c4"
  let s:guishade7 = "#dedede"
  let s:guiaccent0 = "#f53054"
  let s:guiaccent1 = "#eca1b4"
  let s:guiaccent2 = "#b58ddb"
  let s:guiaccent3 = "#b03454"
  let s:guiaccent4 = "#312684"
  let s:guiaccent5 = "#3f37b3"
  let s:guiaccent6 = "#4c2ca4"
  let s:guiaccent7 = "#9c7ade"
  ...
  let s:ctermaccent3 = 132
  let s:ctermaccent4 = 61
  let s:ctermaccent5 = 62
  let s:ctermaccent6 = 61
