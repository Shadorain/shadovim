...
hi Normal guifg=#e2b2ed guibg=none guisp=#1a1a27 gui=NONE ctermfg=219 ctermbg=none cterm=NONE
...
hi PMenuSbar guifg=#eed6ee guibg=#5d596e guisp=#5d5daf gui=NONE ctermfg=255 ctermbg=61 cterm=NONE
hi Identifier guifg=#ff71ff guibg=NONE guisp=NONE gui=NONE ctermfg=207 ctermbg=NONE cterm=NONE
hi SpecialChar guifg=#bc6bd0 guibg=none guisp=#403940 gui=NONE ctermfg=134 ctermbg=238 cterm=NONE
...
hi LineNr guifg=#7676cd guibg=none guisp=none gui=NONE ctermfg=104 ctermbg=236 cterm=NONE
...
hi Character guifg=#26c7c7 guibg=NONE guisp=NONE gui=NONE ctermfg=215 ctermbg=NONE cterm=NONE
hi Float guifg=#c7266c guibg=NONE guisp=NONE gui=NONE ctermfg=215 ctermbg=NONE cterm=NONE
hi Number guifg=#c7266c guibg=NONE guisp=NONE gui=NONE ctermfg=161 ctermbg=NONE cterm=NONE
...
hi Function guifg=#ca49eb guibg=NONE guisp=NONE gui=NONE ctermfg=168 ctermbg=NONE cterm=NONE " #c94c7e
...
hi PMenu guifg=#98a8eb guibg=#3d4878 guisp=#40408f gui=NONE ctermfg=255 ctermbg=60 cterm=NONE
...
hi PMenuThumb guifg=#eed6ee guibg=#373152 guisp=#5d5daf gui=NONE ctermfg=255 ctermbg=61 cterm=NONE
